...
$fieldInstance->name = 'statussoto'; //Usually matches column name
$fieldInstance->table = 'vtiger_registrodeventas';
$fieldInstance->column = 'statussoto'; //Must be lower case
$fieldInstance->label = 'Status Soto'; //Upper case preceeded by LBL_
$fieldInstance->columntype = 'VARCHAR(30)'; //
$fieldInstance->uitype = 16; //textCampo mandatory
