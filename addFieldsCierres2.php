...
$fieldInstance->setRelatedModules(Array('Cierres'));
...
$fieldInstance->label = 'Contacto'; //Upper case preceeded by LBL_
$fieldInstance->columntype = 'INT(11)'; //
$fieldInstance->uitype = 10; //Related module
$fieldInstance->typeofdata = 'N~O'; //V=Varchar?, M=Mandatory, O=Optional
$block2->addField($fieldInstance);

$fieldInstance->setRelatedModules(Array('Contacts'));

$fieldInstance2 = new Vtiger_Field();
$fieldInstance2->name = 'ticketid'; //Usually matches column name
$fieldInstance2->table = 'vtiger_registrodepagos';
$fieldInstance2->column = 'ticketid'; //Must be lower case
$fieldInstance2->label = 'ID Ticket'; //Upper case preceeded by LBL_
$fieldInstance2->columntype = 'INT(11)'; //
$fieldInstance2->uitype = 2; //text no obligatorio
$fieldInstance2->typeofdata = 'N~O'; //V=Varchar?, M=Mandatory, O=Optional
$block2->addField($fieldInstance2);
