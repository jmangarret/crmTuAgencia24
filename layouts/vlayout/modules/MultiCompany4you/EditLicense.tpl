	...
	<div class="CustomLabelModalContainer">
		<div class="modal-header">
			...
			{if $TYPE eq "reactivate"}
				<h3>{vtranslate('LBL_REACTIVATE', 'MultiCompany4you')}</h3>
			{else}
				<h3>{vtranslate('LBL_ACTIVATE_KEY', 'MultiCompany4you')}</h3>
			{/if}
		</div>
		<form id="editLicense" class="form-horizontal contentsBackground" method="post">
				...
				<div class="row-fluid">
					<div class="control-group">
						<label class="muted control-label">{vtranslate('LBL_LICENSE_KEY', 'MultiCompany4you')}</label>
